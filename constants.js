export const ingredientKnowledge = {
  "Masala Dosa": [
    "rice", "urad dal", "fenugreek seeds", "poha",
    "potatoes", "onion", "mustard seeds", "curry leaves",
  ...
  "Szechwan Noodles": [
    "whole wheat noodles", "garlic", "ginger", "spring onion",
    "carrot", "capsicum", "cabbage", "soy sauce",
    "vinegar", "szechwan sauce", "olive oil"
  ],
  "Spring Rolls": [
    "whole wheat wrappers", "cabbage", "carrot", "beans",
    "spring onion", "soy sauce", "black pepper", "olive oil"
  ],
  "Idli": [
    "rice", "urad dal", "fenugreek seeds", "poha",
    "water", "salt"
  ...
  "Chole Bhature": [
    ...
    "chole masala", "whole wheat flour", "curd",
    "baking soda", "salt", "olive oil"
  ],
  "Cold Coffee": [
    "milk", "coffee", "jaggery", "ice cubes"
  ],
  "Veg Biryani": [
